...
const Introduction = () => {
  return (
    <div className="mt-5 mb-14 flex w-full flex-col items-center justify-around fill-current text-primary-500 transition-colors dark:text-primary-300 lg:flex-row-reverse">
      <div className="mb-6 flex flex-1 items-center justify-center">
        <Logo className="h-32 w-32" />
      </div>
      <div className="flex-1">
        <h2 className="header-text my-3 w-full text-4xl font-extrabold duration-500">
          {phrases.Main.name}
        </h2>
