      ...
      <ul className="flex">
        {navLinks.map(({ href, title }, idx) => (
          ...
          >
            <Link
              href={href}
              className={`mx-1 rounded p-1 font-semibold duration-75 sm:px-4 sm:py-2 ${
                isSamePath(title)
...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`w-section fixed left-0 right-0 z-20 flex items-center justify-between border-b-2 bg-white py-2 transition-all duration-75 dark:bg-gray-900 ${
