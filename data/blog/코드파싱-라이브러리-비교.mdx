...
images: [/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/cover.webp]
layout: PostLayout
---
...
![파싱된 코드](/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/parsed-code.webp)
...
![rehype-highlight 파싱 결과](/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/highlight-result.webp)

![rehype-highlight html 결과](/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/highlight-html.webp)
...
![rehype-prism-plus 파싱 결과](/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/prism-plus-result.webp)

![rehype-prism-plus html 결과](/static/images/blog/make-blog-log/코드파싱-라이브러리-비교/prism-plus-html.webp)
