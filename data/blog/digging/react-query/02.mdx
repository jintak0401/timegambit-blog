...
![객체간의 관계](https://i.imgur.com/V8JiWvn.png)
...
### QueryObserver 생성 이후 상태

![QueryObserver 생성 이후 상태](https://i.imgur.com/lgOTZad.png)
...
![3번 라인 후 객체간 관계](https://i.imgur.com/v5cJdXG.png)
...
![객체간 관계](https://i.imgur.com/Q0YLXTr.png)
