...
![28번 라인에서 객체들간의 관계](https://i.imgur.com/OFtPX2V.png)

그리고 30~38번 라인을 수행하면서 다음과 같은 관계로 발전합니다.

![39번 라인에서 객체들간의 관계](https://i.imgur.com/TxRJjbV.png)
...
![mark 이후 관계](https://i.imgur.com/bERpPDW.png)
...
![wrap 이후 관계](https://i.imgur.com/OGA0FV7.png)
...
## 아쉽지만 다음포스트까지...
지금까지의 흐름 중에는 `generator.next` 함수를 정의한 적이 없습니다. 하지만 호출하고 있죠. 이게 어떻게 가능할까요? 사실 이번 포스트에서 async/await 동작원리편을 마무리하려고 했는데 생각보다 많이 길어지네요. 한 호흡에 끝내고 싶었는데 좀 아쉽습니다... 다음 포스트에서 회수하지 못한 떡밥을 회수하고 이 편을 마무리하겠습니다!
