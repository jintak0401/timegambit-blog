---
title: "[Axios] timeout 톺아보기"
date: '2022-12-02'
lastmod: '2022-12-02'
tags: ['톺아보기','axios']
draft: false
series: 톺아보기
summary: axios 라이브러리의 timeout 기능을 분석해봤습니다.
images: [https://i.imgur.com/RUIWbRe.png]
layout: PostLayout
---
...
// callback은 axios/lib/http/http.js의 handleRequestTimeout 함수
...
위에서 axios/lib/http/http.js에 `req = transport.request(...)`라는 코드가 있었습니다.
