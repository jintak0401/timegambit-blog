---
title: "[Axios] 요청취소(cancel) 톺아보기 (feat. Promise)"
date: '2022-12-11'
lastmod: '2022-12-11'
tags: ['톺아보기','axios']
draft: false
series: 톺아보기
summary: axios 라이브러리의 cancel(요청취소) 기능을 분석해봤습니다.
images: [https://i.imgur.com/QWfDHjf.png]
layout: PostLayout
---
...
된다고 느낍니다. 그러면 본격적으로 axios를 톺아보도록 할까요?
...
톺아보기 시리즈는 앞으로 개발자를 하면서 멈추지 않고 쭉 해볼 생각입니다. 이 글을 읽는 여러분들도
톺아보기 시리즈를 통해 조금이나마 새로운 것을 배우거나 깨달을 수 있었으면 하는 바람입니다 🙃
