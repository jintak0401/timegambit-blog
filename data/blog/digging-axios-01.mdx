---
title: "[Axios] interceptor 톺아보기"
date: '2022-11-28'
lastmod: '2022-11-28'
tags: ['톺아보기','axios']
draft: false
series: 톺아보기
summary: axios 라이브러리의 소스코드를 분석해봤습니다.
images: [/static/images/blog/톺아보기/digging-axios-01/cover.webp]
layout: PostLayout
---

## Axios 톺아보기

톺아보기 시리즈는 라이브러리의 사용법을 작성한 글이 아닙니다. 라이브러리의 소스코드를 분석하고, 라이브러리가
...
구현하는 법 등을 알게 되었습니다. 앞으로도 라이브러리들의 소스코드를 뜯어가며 공부하고, *톺아보기* 시리즈로 글을 작성하려고 합니다.
